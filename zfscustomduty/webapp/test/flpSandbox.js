		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#customdutyuiinvoicepostingzfscustomduty-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customdutyuiinvoicepostingzfscustomduty-display": {
								"semanticObject": "customdutyuiinvoicepostingzfscustomduty",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customduty.ui.invoiceposting",
									"url": sap.ui.require.toUrl("customduty/ui/invoiceposting/zfscustomduty")
								}
							}
						}
					}
